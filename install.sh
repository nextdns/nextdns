...
detect_os() {
    ...
    Linux)
        ...
        GNU/Linux)
            ...
            case $dist in
            debian|ubuntu|raspbian|centos|fedora|rhel|arch|manjaro|openwrt|clear-linux-os)
                echo "$dist"; return 0
                ;;
            esac
            ;;
...
bin_location() {
    case $OS in
    centos|fedora|rhel|debian|ubuntu|raspbian|arch|manjaro|openwrt|clear-linux-os)
